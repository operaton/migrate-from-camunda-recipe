...
dependencies {
    rewrite("org.operaton:migrate-camunda-recipe:1.0.0")
}
...
```bash
mvn org.openrewrite.maven:rewrite-maven-plugin:6.22.1:run \
  -Drewrite.recipeArtifactCoordinates=org.operaton:migrate-camunda-recipe:1.0.0 \
